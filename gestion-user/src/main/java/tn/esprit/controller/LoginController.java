    ...
    private void onLogin(){
        ...
        try {
            ...
            if(user != null )
            {
                ...
                if (user.getRoles().contains("ROLE_ENSEIGNANT") || user.getRoles().contains("ROLE_ARTISTE")){
                    ProfileController.user = user;
                    EnseignementController.user = user;
                    EvenementController.user = user;
                    MagasinController.user = user;
                    ReclamationController.user = user;
                    ArtisteController.user = user;
                    ...
                    ProfileController.user = user;
                    AdminEnseignementController.user = user;
                    AdminArtisteController.user = user;
                    AdminMagasinController.user = user;
                    AdminEvenementController.user = user;
                    AdminReclamationController.user = user;
